...
public class GameField {
    ...
    /**
     * Class for ChanceGameField fields. Consists of ChanceGameField main class which sports an ArrayList with hard-coded ChanceEvents objects
     * and a ChanceEvents inner class to make it work. This way you just need to instantiate a ChanceGameField object and draw as
     * many ChanceEvents as you like using ChanceGameField.getChanceEvent().
    ...
    public static class ChanceGameField {
        ...
        /**
         * ChanceEvent data container inner class of ChanceGameField.
         */
